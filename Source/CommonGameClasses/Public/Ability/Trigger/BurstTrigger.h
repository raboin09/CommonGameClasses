...
protected:
	...
	UPROPERTY(EditAnywhere, Category="CUSTOM|Trigger", meta=(ClampMin = 0.f))
	...
	// something like .1)
	UPROPERTY(EditAnywhere, Category="CUSTOM|Trigger", meta=(EditCondition = "NumberOfActivations > 1", ClampMin = 0.f))
