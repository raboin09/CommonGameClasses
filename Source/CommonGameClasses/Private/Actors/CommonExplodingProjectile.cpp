...
void ACommonExplodingProjectile::Internal_Explode()
{
	...
	UEffectUtils::ApplyEffectsToHitResultsInRadius(GetOwner(), ProjectileEffectsToApply, GetActorLocation(), ExplosionRadius, UEngineTypes::ConvertToTraceType(ECC_Visibility), bFriendlyFire ? EAffectedAffiliation::All : EAffectedAffiliation::Enemies, true, GetActorLocation());
	K2_HandleExplosion();
}
